...
import { Search, Zap, Shield, Activity, Brain, LayoutList, Anchor, GitCompare, BookOpen, Users, MessagesSquare } from 'lucide-react';
...
interface DashboardHeaderProps {
    ...
    isScanning: boolean;
    lastUpdated: Date;
    activeView: 'grid' | 'scanner' | 'decision' | 'watchlist' | 'whale' | 'correlation' | 'playbook' | 'sentiment' | 'advisor';
    onViewChange: (view: 'grid' | 'scanner' | 'decision' | 'watchlist' | 'whale' | 'correlation' | 'playbook' | 'sentiment' | 'advisor') => void;
}
